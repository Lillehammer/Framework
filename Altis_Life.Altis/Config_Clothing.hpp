...
class Clothing {
    ...
    class cop {
        ...
        uniforms[] = {
            { "NONE", "Remove Uniform", 0, { "", "", -1 } },
            { "U_B_CombatUniform_mcam_tshirt", "Hose und T-Shirt", 350, { "life_coplevel", "SCALAR", 5 } },
            { "U_B_CombatUniform_mcam_worn", "Volle Uniform", 550, { "life_coplevel", "SCALAR", 2 } }
        };
        headgear[] = {
            { "NONE", "Remove Hat", 0, { "", "", -1 } },
    ...
    class med_clothing {
        ...
        backpacks[] = {
			...
			{ "B_Carryall_oucamo", "Tragerucksack", 3000, { "", "", -1 } }
        };
    };
