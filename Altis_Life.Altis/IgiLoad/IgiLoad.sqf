...
if (isnil "IL_Variables") then
{
	...
	IL_Num_Slots_C17 = -22;
	IL_Num_Slots_Abschlepp = -10;
	IL_Num_Slots_HEMTTCOV = -6;
	...
	IL_Supported_Vehicles_HEMTT = ["B_Truck_01_transport_F", "Marinir_Truck_01_box_FG", "Marinir_Truck_01_transport_FG", "Marinir_Truck_01_covered_FG", "B_mas_mar_Truck_01_covered_F", "B_mas_mar_Truck_01_transport_F"];
	...
	//Supported cargo
	IL_Supported_HEMTT = ["B_Truck_01_covered_F", "B_Truck_01_transport_F", "B_Truck_01_box_F", "Marinir_Truck_01_box_FG", "Marinir_Truck_01_transport_FG", "Marinir_Truck_01_covered_FG", "B_mas_mar_Truck_01_covered_F", "B_mas_mar_Truck_01_transport_F", "B_Truck_01_ammo_F", "B_Truck_01_fuel_F", "B_Truck_01_medical_F", "B_Truck_01_Repair_F"];
	IL_Supported_Abschlepp = ["B_Truck_01_mover_F"];
	IL_Supported_KAMAZ = ["I_Truck_02_transport_F", "I_Truck_02_medical_F", "I_Truck_02_fuel_F", "I_Truck_02_box_F","O_Truck_02_transport_F", "I_Truck_02_covered_F", "O_Truck_02_covered_F", "caf_HLVW_open_AR", "caf_HLVW_open", "caf_HLVW_covered_ar", "caf_HLVW_covered"];
	IL_Supported_TEMPEST = ["O_Truck_03_transport_F", "O_Truck_03_covered_F", "O_Truck_03_device_F"];
	...
	IL_Supported_OFFROAD = ["C_Offroad_01_F", "B_G_Offroad_01_F", "B_G_Offroad_01_armed_F", "C_Offroad_01_repair_F" ,"JTF2_Offroad_armed_01", "B_mas_mar_Offroad_01_F", "B_mas_mar_Offroad_01_armed_F"];
	...
	IL_Supported_Speed = ["C_Boat_Civil_01_police_F","C_Boat_Civil_01_F"];
	...
	IL_Supported_TaruPod = ["Land_Pod_Heli_Transport_04_medevac_F"];
	IL_Supported_HuronPod = ["B_Slingload_01_Ammo_F"];
	//TODO
	...
	IL_Supported_Cargo_Veh_HEMTT = IL_Supported_Cargo_Veh_Kamaz + IL_Supported_OFFROAD + IL_Supported_SUV + IL_Supported_Hunter + IL_Supported_Ifrit + IL_Supported_Strider  + IL_Supported_KAMAZ + IL_Supported_TEMPEST  + IL_Supported_MH9 + IL_Supported_Speed + IL_Supported_Gun + IL_Supported_tarupod + IL_Supported_huronpod;
	...
	IL_Supported_Cargo_Veh_HEMTTCOV = IL_Supported_Cargo_Veh_Kamaz + IL_Supported_OFFROAD + IL_Supported_SUV + IL_Supported_Hunter + IL_Supported_Ifrit + IL_Supported_Strider + IL_Supported_Speed;
	IL_Supported_Cargo_NonVeh_HEMTTCOV = IL_Supported_Cargo_NonVeh_Kamaz;
	IL_Supported_Cargo_HEMTT = IL_Supported_Cargo_Veh_Kamaz + IL_Supported_Cargo_NonVeh_HEMTT;
	
	IL_Supported_Cargo_Veh_Abschlepp = IL_Supported_OFFROAD + IL_Supported_Hatchback+ IL_Supported_VAN + IL_Supported_SUV + IL_Supported_Hunter + IL_Supported_Ifrit + IL_Supported_Strider  + IL_Supported_KAMAZ + IL_Supported_TEMPEST + IL_Supported_HEMTT + IL_Supported_MH9 + IL_Supported_Abschlepp + IL_Supported_APC;
	IL_Supported_Cargo_NonVeh_Abschlepp = IL_Supported_Cargo_NonVeh_Kamaz;
	IL_Supported_Cargo_Abschlepp = IL_Supported_Cargo_NonVeh_HEMTT;
	...
	IL_Supported_Cargo_Veh_Mohawk = IL_Supported_Quadbike + IL_Supported_Rubberboat + IL_Supported_SDV + IL_Supported_Hatchback + IL_Supported_UGV + IL_Supported_SUV + IL_Supported_OFFROAD + IL_Supported_Hatchback;
...
if (isnil "IL_Procedures") then
{
	...
	IL_Init_Veh =
	{
		...
		if (_obj_type in IL_Supported_Vehicles_HEMTTCOV) then
		{
			if ((isNil {_obj getVariable "box_num"}) || (_force)) then {_obj setVariable["box_num", 0, true];};
			if ((isNil {_obj getVariable "slots_num"}) || (_force)) then {_obj setVariable["slots_num", IL_Num_Slots_HEMTT, true];};
			if ((isNil {_obj getVariable "can_load"}) || (_force)) then {_obj setVariable["can_load", true, true];};
		...
		if (_obj_type in IL_Supported_Vehicles_Abschlepp) then
		{
			if ((isNil {_obj getVariable "box_num"}) || (_force)) then {_obj setVariable["box_num", 0, true];};
			if ((isNil {_obj getVariable "slots_num"}) || (_force)) then {_obj setVariable["slots_num", IL_Num_Slots_Abschlepp, true];};
			if ((isNil {_obj getVariable "can_load"}) || (_force)) then {_obj setVariable["can_load", true, true];};
			if ((isNil {_obj getVariable "can_outside"}) || (_force)) then {_obj setVariable["can_outside", IL_Can_Outside, true];};
			if (_obj_type in ["B_Truck_01_box_F", "Marinir_Truck_01_box_FG"]) then
			{
...
//	END IL_Init_Veh
	...
	IL_Init_Box =
	{
		...
		if (_obj_type in IL_Supported_tarupod) then
		{
			_obj setVariable["slots", 6, true];
			_obj setVariable["cargo_offset", 3, true];
		};
		
		if (_obj_type in IL_Supported_huronpod) then
		{
			_obj setVariable["slots", 6, true];
		...
		if (_obj_type in IL_Supported_Abschlepp) then
		{
			_obj setVariable["slots", 10, true];
			_obj setVariable["cargo_offset", 4.2, true];
		};
		...
		if (_obj_type in IL_Supported_MH9) then
		{
			_obj setVariable["slots", 6, true];
		...
		if (_obj_type in IL_Supported_Speed) then
		{
			_obj setVariable["slots", 6, true];
			_obj setVariable["cargo_offset", 2.7, true];
		};
		if (_obj_type in IL_Supported_Gun) then
		{
			_obj setVariable["slots", 6, true];
			_obj setVariable["cargo_offset", 4.2, true];
		};
		...
		{
			_obj setVariable["slots", 10, true];
			_obj setVariable["cargo_offset", 3.2, true];
		};
...
//	END IL_Cargo_Para
	...
	IL_Do_Load =
	{
		...
		if ((_obj_type in IL_Supported_Vehicles_HEMTTCOV) && (_doors == "B")) then
		{
			if (IL_DevMod) then
			{
				Player globalChat Format ["IgiLoad ""%1"". Do_load vehicle type: ""%2"" and doors: ""%3""", IL_Script_Inst, _obj_type, _doors];
		...
		if ((_obj_type in IL_Supported_Vehicles_Abschlepp) && (_doors == "B")) then
		{
			if (IL_DevMod) then
			{
				Player globalChat Format ["IgiLoad ""%1"". Do_load vehicle type: ""%2"" and doors: ""%3""", IL_Script_Inst, _obj_type, _doors];
		...
		{
			{
				...
				else
				{
					...
					if ((_box_num > _slot_num) && !_done) then
					{
						...
						if ((_obj_type in IL_Supported_Vehicles_Abschlepp) && (_doors == "B")) then
						{
							[_v, _x, [_x_cargo_offset,-7 - _cargo_offset,_zload], [_x_cargo_offset,_counter + -5 - _cargo_offset,0.5], 1, _turn] call IL_Move_Attach;
//																											aufladeabstand	     höhe														
						};
						if ((_obj_type in IL_Supported_Vehicles_TEMPEST) && (_doors == "B")) then
						{
		...
		{
			{
				...
				if (_x getVariable "doors" == _doors) then
				{
					...
					if (((_x getVariable "attachedTruck") == _v) && ((_x getVariable "attachedPos") == (_counter)) && (_counter < 0) && !_done) then
					{
						...
						if ((_obj_type in IL_Supported_Vehicles_Abschlepp) && (_doors == "B")) then
						{
//																	ka								entfernung beim abladen						
							[_v, _x, [_x_cargo_offset,_counter + 0.25 - _cargo_offset,_zload], [_x_cargo_offset,-9 - _cargo_offset,_zload], 1, _turn] call IL_Move_Attach;
						};
						if ((_obj_type in IL_Supported_Vehicles_TEMPEST) && (_doors == "B")) then
						{
...
if (_obj_main_type in IL_Supported_Vehicles_MOHAWK) then
{
	...
	_obj_main addAction [
	"<t color=""#ffffff"">Open cargo ramp in CH-49</t>",
	{
	...
	_obj_main addAction [
	"<t color=""#ffffff"">Close cargo ramp in CH-49</t>",
	{
	...
	_obj_main addAction [
	"<t color=""#ffffff"">Enable loading for Co-Pilot</t>",
	{
	...
	_obj_main addAction [
	"<t color=""#ffffff"">Disable loading for Co-Pilot</t>",
	{
	...
	_obj_main addAction [
	"<t color=""#ffffff"">Enable loading from outside</t>",
	{
	...
	_obj_main addAction [
	"<t color=""#ffffff"">Disable loading from outside</t>",
	{
	...
	_obj_main addAction [
	"<t color=""#ffffff"">Enable usable ramp</t>",
	{
	...
	_obj_main addAction [
	"<t color=""#ffffff"">Disable usable ramp</t>",
	{
...
if (_obj_main_type in IL_Supported_Vehicles_CHINOOK) then
{
	...
	if (typeOf _obj_main == "CH_147F") then
	{
		...
		_obj_main addAction [
		"<t color=""#ffffff"">Open cargo ramp in Chinook</t>",
		{
		...
		_obj_main addAction [
		"<t color=""#ffffff"">Close cargo ramp in Chinook</t>",
		{
...
//		"('Cargo' in (assignedVehicleRole _this)) && (vehicle _this == _target) && (((getPosATL _target) select 2) >= IL_Para_Jump_ATL) && (_target animationPhase 'ramp_bottom' < 0.1) && (_target getVariable 'usable_ramp')"
	...
	// _obj_main addAction [
	// "<t color=""#ffffff"">Open lower part of ramp in C-130J</t>",
	// {
	...
	// _obj_main addAction [
	// "<t color=""#ffffff"">Close lower part of ramp in C-130J</t>",
	// {
...
if (_obj_main_type in IL_Supported_Vehicles_C17) then
{
	...
	_obj_main addAction [
	"<t color=""#ffffff"">Open cargo doors in C17</t>",
	{
	...
	_obj_main addAction [
	"<t color=""#ffffff"">Close cargo doors in C17</t>",
	{
...
if (_obj_main_type in IL_Supported_Vehicles_HEMTTCOV) then
{
	if (IL_DevMod) then
	{
		Player globalChat Format["IgiLoad ""%1"" Vehicle is in IL_Supported_Vehicles_HEMTT.", IL_Script_Inst];
	...
	"<img image='IgiLoad\images\load.paa' /><t color=""#007f0e"">  Load cargo on HEMTT</t>",
	{
		[_this select 0, IL_Supported_Cargo_NonVeh_HEMTTCOV] call IL_Do_Load;
	},[],IL_Action_LU_Priority,true,true,"",
	"(count(nearestObjects[ _target modelToWorld [0,-7 - (_target getVariable 'load_offset'),0], IL_Supported_Cargo_NonVeh_HEMTT, IL_SDistL]) > 0) && (abs(speed _target) <= IL_LU_Speed) && ((IL_Can_Inside && (driver _target == _this)) || (((_this in (nearestObjects[ _target modelToWorld [0,-7 - (_target getVariable 'load_offset'),0], [], IL_SDistL + IL_SDistL_Heli_offset])) && (_target getVariable 'can_outside')))) && (_target getVariable 'box_num' > _target getVariable 'slots_num') && (_target getVariable 'can_load')"
	];
	...
	"<img image='IgiLoad\images\load.paa' /><t color=""#007f0e"">  Load vehicle on HEMTT</t>",
	{
		[_this select 0, IL_Supported_Cargo_Veh_HEMTTCOV] call IL_Do_Load;
	},[],IL_Action_LU_Priority,true,true,"",
	"(count(nearestObjects[ _target modelToWorld [0,-7 - (_target getVariable 'load_offset'),0], IL_Supported_Cargo_Veh_HEMTT, IL_SDistL]) > 0) && (abs(speed _target) <= IL_LU_Speed) && ((IL_Can_Inside && (driver _target == _this)) || (((_this in (nearestObjects[ _target modelToWorld [0,-7 - (_target getVariable 'load_offset'),0], [], IL_SDistL + IL_SDistL_Heli_offset])) && (_target getVariable 'can_outside')))) && (_target getVariable 'box_num' > _target getVariable 'slots_num') && (_target getVariable 'can_load')"
	];
...
if (_obj_main_type in IL_Supported_Vehicles_Abschlepp) then
{
	if (IL_DevMod) then
	{
		Player globalChat Format["IgiLoad ""%1"" Vehicle is in IL_Supported_Vehicles_Abschlepp.", IL_Script_Inst];
	};
	_vsupported = true;
	[_obj_main] call IL_Init_Veh;

	_obj_main addAction [
	"<img image='IgiLoad\images\load.paa' /><t color=""#007f0e"">  Load cargo on HEMTT-Abschlepp</t>",
	{
		[_this select 0, IL_Supported_Cargo_NonVeh_Abschlepp] call IL_Do_Load;
	},[],IL_Action_LU_Priority,true,true,"",
	"(count(nearestObjects[ _target modelToWorld [0,-8 - (_target getVariable 'load_offset'),0], IL_Supported_Cargo_NonVeh_Abschlepp, IL_SDistL]) > 0) && (abs(speed _target) <= IL_LU_Speed) && ((IL_Can_Inside && (driver _target == _this)) || (((_this in (nearestObjects[ _target modelToWorld [0,-8 - (_target getVariable 'load_offset'),0], [], IL_SDistL + IL_SDistL_Heli_offset])) && (_target getVariable 'can_outside')))) && (_target getVariable 'box_num' > _target getVariable 'slots_num') && (_target getVariable 'can_load')"
	];

	_obj_main addAction [
	"<img image='IgiLoad\images\load.paa' /><t color=""#007f0e"">  Load vehicle on HEMTT-Abschlepp</t>",
	{
		[_this select 0, IL_Supported_Cargo_Veh_Abschlepp] call IL_Do_Load;
	},[],IL_Action_LU_Priority,true,true,"",
	"(count(nearestObjects[ _target modelToWorld [0,-8 - (_target getVariable 'load_offset'),0], IL_Supported_Cargo_Veh_Abschlepp, IL_SDistL]) > 0) && (abs(speed _target) <= IL_LU_Speed) && ((IL_Can_Inside && (driver _target == _this)) || (((_this in (nearestObjects[ _target modelToWorld [0,-8 - (_target getVariable 'load_offset'),0], [], IL_SDistL + IL_SDistL_Heli_offset])) && (_target getVariable 'can_outside')))) && (_target getVariable 'box_num' > _target getVariable 'slots_num') && (_target getVariable 'can_load')"
	];

	_obj_main addAction [
	"<img image='IgiLoad\images\unload.paa' /><t color=""#ff0000"">  Unload cargo from HEMTT-Abschlepp</t>",
	{
		[_this select 0] call IL_Do_Unload;
	},[],IL_Action_LU_Priority,false,true,"",
	"(_target getVariable 'box_num' < 0) && ((IL_Can_Inside && (driver _target == _this)) || (((_this in (nearestObjects[ _target modelToWorld [0,-7 - (_target getVariable 'load_offset'),0], [], IL_SDistL + IL_SDistL_Heli_offset])) && (_target getVariable 'can_outside')))) && (_target getVariable 'can_load') && (abs(speed _target) <= IL_LU_Speed)"
