...
if(_ctrl in ["goldbar","cocaine_unprocessed","cannabis","heroin_unprocessed","salt_unrefined","sand"] && {!(life_trunk_vehicle isKindOf "LandVehicle")}) exitWith {hint "You cannot store that in anything but a land vehicle!"};
